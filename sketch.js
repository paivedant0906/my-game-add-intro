  ...
  function setup() {
   ...
   // creating background1.
    ...
    start=createSprite(80,displayHeight-200,50,50);
...
p1=createSprite(100,displayHeight/2+140,50,50);
 ...
 if(gameState==="intro"){
     ...
     drawSprites()
        fill("black")
     textSize(20)
     text("INTRODUCTION TO SURVIVAL OF EARTH",displayWidth/2-300,50)
     text("YOU HAVE TO SAVE THE EARTH FROM THE CLUTCHES OF GLOBAL WARMING",displayWidth/2-300,100)
     text("BY SAVING IT FROM THE FACTORS OF GLOBAL WARMING",displayWidth/2-300,150)
   
     fill("black")
     textSize(40)
        text("TO SAVE THE EARTH PRESS START",50,displayHeight-250)
        start.visible=true;
...
piground.y=displayHeight/2+20
p1.y=displayHeight/2
    ...
    if(frameCount%150===0){
      ...
      switch(obrandi){
        case 1:obstaclei.addImage(o1);
               obstaclei.scale=1.6;
               obstaclei.y=displayHeight/2-20;
